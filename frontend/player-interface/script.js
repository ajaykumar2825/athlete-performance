...
async function fetchPerformanceHistory(athleteId, metric = 'accuracy') {
    try {
        const response = await fetch(`https://athlete-performance-1.onrender.com/performance/history/${athleteId}?metric=${metric}`);
...
async function fetchBestWorstPerformance(athleteId) {
    try {
        const response = await fetch(`https://athlete-performance-1.onrender.com/performance/bestworst/${athleteId}`);
...
async function connectPlayerToBackend(fullName) {
  try {
    ...
    const response = await fetch("https://athlete-performance-1.onrender.com/athletes/");
