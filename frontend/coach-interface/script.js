...
function showApp(name) {
  ...
  fetch("https://athlete-performance-1.onrender.com/athletes/")
    .then(r => r.json())
    .then(data => {
...
window.addAthlete = async function() {
  ...
  try {
    const response = await fetch(
      `https://athlete-performance-1.onrender.com/athletes/?full_name=${encodeURIComponent(fullName)}&sport=${encodeURIComponent(sport)}`,
      { method: "POST" }
    );
...
window.removeAthlete = async function(athleteId) {
  ...
  try {
    const response = await fetch(`https://athlete-performance-1.onrender.com/athletes/${athleteId}`, {
      method: "DELETE"
    });
...
window.addEventForPlayer = async function() {
  ...
  try {
    // ✅ FIXED: Change "http://st:8000" to "https://athlete-performance-1.onrender.com"
    const response = await fetch(
      `https://athlete-performance-1.onrender.com/dates/${currentModalAthleteId}`,
      {
        method: "POST",
        headers: {
...
window.addMessageForPlayer = async function() {
  ...
  try {
    const response = await fetch(
      `https://athlete-performance-1.onrender.com/messages/${currentModalAthleteId}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
...
async function loadDatesFromBackend(athleteId) {
  try {
    const response = await fetch(
      `https://athlete-performance-1.onrender.com/dates/${athleteId}`
    );
...
async function deleteMessage(messageId) {
  ...
  try {
    const response = await fetch(
      `https://athlete-performance-1.onrender.com/messages/${messageId}`,
      { method: "DELETE" }
    );
...
async function deleteDate(dateId) {
  ...
  try {
    const response = await fetch(
      `https://athlete-performance-1.onrender.com/dates/${dateId}`,
      { method: "DELETE" }
    );
...
async function loadMessagesFromBackend(athleteId) {
  try {
    const response = await fetch(
      `https://athlete-performance-1.onrender.com/messages/${athleteId}`
    );
...
const response = await fetch(
  `https://athlete-performance-1.onrender.com/analysis/${athleteId}?practice_date=${practiceDate}`,
  {
    method: "POST",
    body: formData
  }
